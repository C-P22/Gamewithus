import pygame
from Beispielcode.Lichteffekt import Config
import math
from Beispielcode.Lichteffekt.angle_sort import sort_by_angle
...
class light_handling:
    ...
    def extract_polygon(self):
        ...
        for vertex in sorted_points:
            ...
            min_dist['curr'], closest_point['curr'], closest_wall['curr'] = intersect_walls(curr_walls, light_vec,
                                                                                            self.mouse_pos)
            min_dist['new'], closest_point['new'], closest_wall['new'] = intersect_walls(new_buffer, light_vec,
                                                                                         self.mouse_pos)
            min_dist['rm'], closest_point['rm'], closest_wall['rm'] = intersect_walls(rm_buffer, light_vec,
                                                                                      self.mouse_pos)
    ...
    def draw(self, surface: pygame.Surface):
        if self.mouse_pos != None:
            ...
            surface.blit(self.light_effect,
                         (self.mouse_pos[0] - self.effect_size[0] / 2, self.mouse_pos[1] - self.effect_size[1] / 2))
